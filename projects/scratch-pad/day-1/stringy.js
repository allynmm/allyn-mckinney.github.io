...
function toLowerCase(string) {
    // YOUR CODE BELOW HERE //
    //create a variable to store lowercase version of input string
...
function toUpperCase(string) {
    // YOUR CODE BELOW HERE //
    //create a variable to store uppercase version of input string
...
function toDashCase(string) {
    ...
    //join w a dash
    var dashedWords = wordArray.join('-');
    //return
    return dashedWords;
    // YOUR CODE ABOVE HERE //
}
...
function endsWith(string, char) {
    ...
    if (lowString[lowString.length - 1] === lowChar) {
        return true;
    } else {
        return false;
    }
